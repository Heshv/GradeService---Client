 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://webservices.gradeservice/", wsdlLocation = "http://localhost:17331/NewWebService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://webservices.gradeservice/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:17331/NewWebService/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://webservices.gradeservice/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.gradeservice/", "NewWebServicePort"), NewWebService.class, features);
    }
